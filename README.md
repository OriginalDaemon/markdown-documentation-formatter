...
A system to take product documentation stored in markdown and process it in various ways to ready it for deployment. This allows you to automate various parts of documentation maintenance such as;
 ...
 - Use variables in the form ${variable_name} throughout the documentation and have them filled automatically using values from a configured consts file - which itself can be a python module.
...
This system is also extensible so you can add rules of your own. The overall aim is to be able to store your documentation with your code, in a form that is convenient to use when working on it, but massage it into a nicer form for users to read.
